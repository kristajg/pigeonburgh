	...
	render() {
		return (
			<div>
				...
				<Pigeongraph>
					With the grace of a 120 year old sea turtle you carve slow S&#39;s down the hill. In that moment you swear you
					are infinite - since it certainly takes you long enough to complete the race.
				</Pigeongraph>
				<Pigeongraph>
