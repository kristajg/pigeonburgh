...
const Step13 = ({ changeStep, changeSubstep }) => (
	<div>
		<Pigeongraph>
			You decide the Supercomputing Center is the center for all things super and computing. Seeing as this binary code
			probably definitely relates to computers, you decide to check it out.
		</Pigeongraph>
		<Pigeongraph>
